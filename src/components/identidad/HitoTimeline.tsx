          ...
          >
            ...
            <div className="flex-1 bg-white rounded-2xl border border-gray-100 hover:border-gold/30 hover:shadow-md transition duration-300 p-5 flex gap-4 items-start">
              ...
              <div className="flex-1 pt-1">
                {hito.titulo && (
                  <p className="font-display font-bold text-primary text-sm mb-1">{hito.titulo}</p>
                )}
                <p className="text-gray-600 font-body text-sm leading-relaxed">{hito.descripcion}</p>
              </div>
            </div>
          </motion.div>
        ))}
