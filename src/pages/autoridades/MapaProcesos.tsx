  ...
  return (
    <div className="bg-white py-16 md:py-20 overflow-hidden">
      <div className="container mx-auto px-4 md:px-8">
        <SectionTitle title="MAPA DE PROCESOS DEL **SISTEMA DE GESTIÓN DE CALIDAD**" center subtitle={`Organización de Procesos Estratégicos, Misionales y de Apoyo de la UNT`} />

        <div className="mt-12">
          <p className="text-center font-display font-bold text-ink mb-4">
            Nivel 0 – Vista General de Procesos
          </p>
          <a
            href={mapaProcesos}
            target="_blank"
            ...
            title="Abrir el mapa de procesos en tamaño completo"
          >
            <img
              src={mapaProcesos}
              alt={`Mapa de procesos del ${site.denominacion}`}
              loading="lazy"
